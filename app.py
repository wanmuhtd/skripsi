    ...
    with col_right:
        if predict_btn:
            ...
            with st.container(border=True):
                ...
                st.markdown(
                    "<div style='height: 450px; display: flex; align-items: center; justify-content: center; color: #484f58; text-align: center; border: 1px dashed #30363d; border-radius: 10px;'>"
